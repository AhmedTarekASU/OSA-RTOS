...
;osa_csem.c,66 :: 		
	BCF         __OS_Flags+0, 0 
;osa_csem.c,68 :: 		
	MOVFF       FARG__OS_Csem_Signal_pCSem+0, FSR0
	MOVFF       FARG__OS_Csem_Signal_pCSem+1, FSR0H
	MOVFF       FARG__OS_Csem_Signal_pCSem+0, FSR1
